// Importing React and hooks for managing component lifecycle
import React, { useRef, useEffect } from 'react';

// Importing Drei hooks for loading models and animations
import { useGLTF, useFBX, useAnimations } from '@react-three/drei';

export function BaseModel1(props) {
  ...
  // Load the GLTF model
  const { nodes, materials } = useGLTF('/GLBs/outfit1.glb');
  ...
  // To handle animation playback and cleanup
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <group rotation-x={-Math.PI / 2}>
        {/* Attach the skeleton root (Hips) to the model */}
        ...
        <skinnedMesh
          ...
          material={materials.Wolf3D_Eye}             l
        ...
        - material: Determines the visual appearance of the mesh.
...
// Preload the GLTF model to improve performance and reduce loading times during runtime
